...
class AsignacionController extends Controller
{
    public function index(Request $request)
    {
        ...
        $asignaciones = DB::table('parqueo')
            ...
            ->select('parqueo.id', 'parqueo.zona', 'parqueo.sitio', 'parqueo.estado', 'parqueo.descripcion', 'parqueo.fechaasig', 'usercustom.nombre', 'usercustom.telefono', 'usercustom.ci', 'usercustom.rol')
